...
export const CompanionFindUniqueArgsSchema: z.ZodType<Prisma.CompanionFindUniqueArgs> = z.object({
  select: CompanionSelectSchema.optional(),
  include: z.lazy(() => CompanionIncludeSchema).optional(),
  where: CompanionWhereUniqueInputSchema,
}).strict() as z.ZodType<Prisma.CompanionFindUniqueArgs>;

export default CompanionFindUniqueArgsSchema;
