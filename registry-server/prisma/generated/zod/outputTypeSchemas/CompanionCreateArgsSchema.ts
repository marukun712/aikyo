...
export const CompanionCreateArgsSchema: z.ZodType<Prisma.CompanionCreateArgs> = z.object({
  select: CompanionSelectSchema.optional(),
  include: z.lazy(() => CompanionIncludeSchema).optional(),
  data: z.union([ CompanionCreateInputSchema,CompanionUncheckedCreateInputSchema ]),
}).strict() as z.ZodType<Prisma.CompanionCreateArgs>;

export default CompanionCreateArgsSchema;
