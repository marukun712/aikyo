...
export const FurnitureDeleteArgsSchema: z.ZodType<Prisma.FurnitureDeleteArgs> = z.object({
  select: FurnitureSelectSchema.optional(),
  include: z.lazy(() => FurnitureIncludeSchema).optional(),
  where: FurnitureWhereUniqueInputSchema,
}).strict() as z.ZodType<Prisma.FurnitureDeleteArgs>;

export default FurnitureDeleteArgsSchema;
