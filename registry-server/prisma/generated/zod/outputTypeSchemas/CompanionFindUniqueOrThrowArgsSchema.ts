...
export const CompanionFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.CompanionFindUniqueOrThrowArgs> = z.object({
  select: CompanionSelectSchema.optional(),
  include: z.lazy(() => CompanionIncludeSchema).optional(),
  where: CompanionWhereUniqueInputSchema,
}).strict() as z.ZodType<Prisma.CompanionFindUniqueOrThrowArgs>;

export default CompanionFindUniqueOrThrowArgsSchema;
